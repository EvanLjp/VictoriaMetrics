...
* BUGFIX: properly cancel forced merge on the shutdown. Before, stopping the VictoriaMetrics single-server or vmstorage during forced merge could resulted into a panic. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5944) for the details.
